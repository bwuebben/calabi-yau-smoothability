...
\hypersetup{pdfauthor={Bernd Johannes Wuebben},
  pdftitle={Smoothing Calabi-Yau threefolds in Gorenstein toric Fano fourfolds}}
...
category alike, the same group as $\operatorname{Cl}(C(F))$; analytically,
this follows from the exponential sequence, using
$H^1(S,\mathcal O_S)=H^2(S,\mathcal O_S)=0$, and the Gysin sequence for
the associated $\CC^\ast$-bundle.  Such a
